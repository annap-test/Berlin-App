...
def main() -> None:
    ap = argparse.ArgumentParser(description="Compute mobility labels from U-Bahn, S-Bahn, and Bus/Tram stops")
    ...
    ap.add_argument("sbahn_csv", help="CSV of S-Bahn stations with lat/lon or geometry")
    ...
    df_sbahn = load_csv(args.sbahn_csv)
    df_bus = load_csv(args.bus_tram_csv)

    labels = compute_mobility_labels(gdf_nei, df_ubahn, df_sbahn, df_bus)
